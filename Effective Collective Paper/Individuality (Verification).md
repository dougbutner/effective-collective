...
Because there are systems already using these approaches, it is possible to hook into these systems, or fork them. This makes the tech needed to implement Effective Collective on a global scale already here, and a feasible amount of effort needed to run the system. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MzU2MDk3MywtNjEwMjM1NjUsLTIwMT
