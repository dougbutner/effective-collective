...
Benefits like infinitely recoverable accounts may or may not exist depending on the implementations. Private keys should not be generated by social verification data, but in the traditional way, the [ECDSA](https://en.wikipedia.org/wiki/Elliptic_Curve_Digital_Signature_Algorithm?ref=hackernoon.com). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4NzgzOTg4NCwtNjM4MjExNzQsLTE2OD
